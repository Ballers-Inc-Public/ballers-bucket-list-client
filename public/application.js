...
/***/ (function(module, exports, __webpack_require__) {
	...
	var goals = __webpack_require__(11);
	...
	var onInitialPageLoadHide = function onInitialPageLoadHide() {
	  $('form').hide();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  $('.alert').hide();
	  // Blank Field Check
	  if (data.credentials.password === '' || data.credentials.password_confirmation === '' || data.email === '') {
	...
	var onToggleSignUp = function onToggleSignUp() {
	  ui.resetUserForms();
	  $('#sign-in').slideUp();
	  $('#sign-up').slideToggle();
	};

	var onToggleSignIn = function onToggleSignIn() {
	  ui.resetUserForms();
	  $('#sign-up').slideUp();
	  $('#sign-in').slideToggle();
	};

	var onToggleChangePWord = function onToggleChangePWord() {
	  ui.resetUserForms();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var resetUserForms = function resetUserForms() {
	  $('.alert').hide();
	...
	var signInSuccessRenderUI = function signInSuccessRenderUI() {
	  $('form').hide();
	...
	var signOutSuccessRenderUI = function signOutSuccessRenderUI() {
	  $('form').hide();
	  $('.hide-on-initial-load').hide();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetGoals = function onGetGoals() {
	  // API request for index all
	  api.getGoals().then(ui.getGoalsSuccess).catch(ui.Failure);
	};

	// On Create Goal
	var onCreateGoal = function onCreateGoal(event) {
	  event.preventDefault();
	  $('.alert').hide();
	  if (store.user === undefined) {
	    // //console.log('Not signed In')
	  ...
	  api.createGoal(data).then(onGetGoals).then(ui.createGoalSuccess).catch(ui.Failure);
	};
	// On Update goal___________________
	var onUpdateGoal = function onUpdateGoal(event) {
	  event.preventDefault();
	  $('.alert').hide();
	  // //console.log('Changing password run')
	  var data = getFormFields(this);
	  ...
	  if (data.goal.title === $('#title-' + data.goal.id).text() && data.goal.status === $('#status-' + data.goal.id).text()) {
	  ...
	  api.updateGoal(data).then(ui.updateGoalSucess).then(onGetGoals).catch(ui.failure);
	};

	// On Delete Goal
	var onDeleteGoal = function onDeleteGoal(event) {
	  event.preventDefault();
	  // HOW DOES THE FUNCTION GET THE ID OF THE GOAL
	  var id = $(event.target).parents('tr').attr('data-id');
	  //console.log(id)
	  api.deleteGoal(id).then(ui.deleteGoalSuccess).then(onGetGoals).catch(ui.failure);
	};

	var goalStatusSetState = function goalStatusSetState(event) {
	  event.preventDefault();
	  $('#goal-status-select').text(event.currentTarget.text);
	};

	var onLoadUpdateForm = function onLoadUpdateForm(event) {
	  event.preventDefault();
	  $('.alert').hide();
	  var id = $(event.target).parents('tr').attr('data-id');
	  //console.log(event)
	...
	module.exports = {
	  ...
	  goalStatusSetState: goalStatusSetState,
	  onGetGoals: onGetGoals
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createGoal = function createGoal(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/goals',
	    method: 'POST',
	    beforeSend: function beforeSend() {
	...
	var updateGoal = function updateGoal(data) {
	  return $.ajax({
	    method: 'PATCH',
	    beforeSend: function beforeSend() {
	      $('loader').show();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(8);
	var showGoals = __webpack_require__(14);

	var resetGoalForms = function resetGoalForms() {
	  $('#modify-goal').trigger('reset');
	  $('#add-goal').trigger('reset');
	};

	var limitGoalsToCurrentUser = function limitGoalsToCurrentUser(data) {
	  var userOnlyData = [];
	...
	var getGoalsSuccess = function getGoalsSuccess(data) {
	...
	var createGoalSuccess = function createGoalSuccess(data) {
	  //console.log('Create goal was successful')
	  //console.log('Your data looks likes', data)
	  resetGoalForms();
	};

	var updateGoalSucess = function updateGoalSucess(data) {
	...
	var deleteGoalSuccess = function deleteGoalSuccess() {
	...
	module.exports = {
	  limitGoalsToCurrentUser: limitGoalsToCurrentUser,
	  deleteGoalSuccess: deleteGoalSuccess,
	  failure: failure,
	  updateGoalSucess: updateGoalSucess,
	  getGoalsSuccess: getGoalsSuccess,
	  createGoalSuccess: createGoalSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n//console.log(goal)\n<tr data-id="
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "'>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.status : stack1), depth0))
	    + "</td>\n  <td><button type=\"button\" id='modify-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	  ...
	  return "\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.goals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
